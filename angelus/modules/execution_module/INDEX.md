...
| [execution_attempt.py](execution_attempt.py#L153) | `ExecutionAttempt.commit_checkpoint` | `generation: str, graph: dict[str, object] \| None, contexts: dict[str, dict[str, object]], reason: str, run_graph: dict[str, object] \| None, recovery: dict[str, object] \| None` | `dict[str, object]` | Commit one complete graph/context generation through this attempt. |
| [execution_attempt.py](execution_attempt.py#L171) | `ExecutionAttempt.mark_interrupted` | `reason: str` | `None` | Persist an unconfirmed terminal when host shutdown exceeds deadline. |
| [execution_attempt.py](execution_attempt.py#L186) | `ExecutionAttempt._run` | `operation: Callable[[ExecutionController], ResultT]` | `None` | Run operation and publish one mutually exclusive terminal outcome. |
| [execution_attempt.py](execution_attempt.py#L213) | `ExecutionAttempt._write_manifest` | `None` | `None` | Atomically project current lifecycle and latest checkpoint to manifest. |
