...
| `external-agents.js` | ES module | Standalone External Agent Hub: safe local Provider auto-detection/setup/probe, session discovery/linking, lease heartbeat and capability-gated fixed controls; never accesses credentials. |
