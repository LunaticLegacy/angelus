...
| `external-agents.js` | ES module | Standalone External Agent Hub: Provider setup/probe, session discovery/linking, lease heartbeat and capability-gated fixed controls; never accesses credentials. |
