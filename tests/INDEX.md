...
| [test_session_console.py](test_session_console.py#L167) | `SessionConsoleTests.test_detached_previews_restore_context_without_dispatch_or_writes` | `None` | `None` | Both previews compose from checkpoint state without saving the draft. |
